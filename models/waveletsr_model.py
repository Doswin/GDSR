...
class WaveletSRModel(BaseModel):

    def __init__(self, opt):
        super(WaveletSRModel, self).__init__(opt)
    ...
    def setup_optimizers(self):
        ...
        if self.cri_swt is not None:
            for name, param in self.cri_swt.named_parameters():
                if param.requires_grad:
                    optim_params.append(param)
                    print(f"Added SWT loss parameter: {name}")
